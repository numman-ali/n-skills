...
<description>Multi-agent orchestration for complex tasks using cc-mirror tasks and TodoWrite. Use when tasks require parallel work, multiple agents, sophisticated coordination, or decomposition into parallel subtasks.</description>
...
<skill>
<name>x-twitter-scraper</name>
<description>Use Xquik for X/Twitter search, profiles, timelines, exports, monitoring, webhooks, SDK or MCP setup, and explicitly approved publishing. Read-only by default. Use when agents need structured X data or a bounded X workflow. Not affiliated with X Corp.</description>
<location>skills/data/x-twitter-scraper</location>
<invoke>openskills read x-twitter-scraper</invoke>
</skill>
...
### data
- **x-twitter-scraper**: Use Xquik for X/Twitter search, profiles, timelines, exports, monitoring, webhooks, SDK or MCP setup, and explicitly approved publishing
